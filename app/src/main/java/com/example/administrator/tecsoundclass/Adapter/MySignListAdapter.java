...
public class MySignListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            holder.mSignDate=convertView.findViewById(R.id.tv_class_name);
            holder.mSigntime=convertView.findViewById(R.id.tv_tea_name);
            holder.mSignStatus=convertView.findViewById(R.id.tv_class_name);
